...
<meta name="_csrf_header" content="<%=token.headerToken()%>"/><link rel="icon" href="${pageContext.request.contextPath}/favicon.ico"/><meta name="viewport" content="width=device-width,initial-scale=1"/><meta name="theme-color" content="#000000"/><link rel="manifest" href="${pageContext.request.contextPath}/manifest.json"/><title>Основная страница</title><script defer="defer" src="${pageContext.request.contextPath}/static/js/main.0eaa5459.js"></script><link href="${pageContext.request.contextPath}/static/css/main.a757c0b9.css" rel="stylesheet"></head><body><div id="header" class="container"><div class="container"><h2>Стрельбицкий Илья</h2></div><div class="container column"><h3>Группа P32101</h3><h4>3210199 вариант</h4></div></div><noscript>You need to enable JavaScript to run this app.</noscript><div id="root"></div></body></html>